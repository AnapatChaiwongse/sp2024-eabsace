class InstructionsHandler:
    ...
    def load_instruction_set1(self, ):
        ...
        output: positive
        Positive example 2-
        input: He's a good teacher. I see my change, thank you kubb! The aspect is instructor.
        output: positive
        Negative example 1-
        input: The teaching is done on time but never works in the period. The aspect is organization.
        output: negative
        Negative example 2-
        input: Change the way U taught, not copy from book. Make it simplify and easy for student to learn. The aspect is instructor.
        output: negative
        Neutral example 1-
        input: I really like how [instructor] listens to [instructor] students and adaptable. The aspect is organization.
        output: neutral
        Neutral example 2-
        input: The instructor should prepare materials and platform for student can student and do the lab more appropriate. The aspect is content quality.
        output: neutral
        Now complete the following example-
        input: """
        ...
        Negative example 1-
        input: Please extend the period assignment deadline by a day. The aspect is organization.
        output: negative
        Negative example 2- 
        input: The number of assignments is quite too much. The aspect is content quality.
        output: Negative
        Now complete the following example-
        input: """
