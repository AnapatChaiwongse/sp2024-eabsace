...
from test_SAMS import predict_val, predict_test
import matplotlib
...
class Seq2SeqModel:
    def __init__(
        ...
        **kwargs,
        ...
        print("Initialize the model and token")
    ...
    def train_model(
        ...
        if os.path.exists(output_dir) and os.listdir(output_dir) and not self.args.overwrite_output_dir:
            raise ValueError(
                ...
                " Set args.overwrite_output_dir = True to overcome."
            )
        ...
        if verbose:
            logger.info(f"Training of {self.args.model_name} model complete. Saved to {output_dir}.")
