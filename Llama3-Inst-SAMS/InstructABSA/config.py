...
class Config(object):
    ...
    def __init__(self):
        ...
        # self.auto_find_batch_size = True
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-evaluation_strategy', help='no/epoch/steps', default='no', type=str)
        ...
        # parser.add_argument('-auto_find_batch_size', help='Enable automatic batch size tuning', default=True, type=bool)
