class InstructionsHandler:
    ...
    def load_instruction_set1(self, ):
        ...
        self.atsc['bos_instruct1'] = """Definition: The output will be 'positive' if the sentence contains a positive sentiment. If the sentence in the input is negative the answer will be 'negative'.
        Otherwise, the output should be 'neutral'. For sentence which are classified as noaspectterm, the sentiment is neutral.
        Positive example 1-
        input: You are very kind and I really like your teaching style.
        output: positive
        Positive example 2-
        input: He's a good teacher. I see my change, thank you kubb!
        output: positive
        Negative example 1-
        input: The teaching is done on time but never works in the period.
        output: negative
        Negative example 2-
        input: Change the way U taught, not copy from book. Make it simplify and easy for student to learn.
        output: negative
        Neutral example 1-
        input: I really like how [instructor] listens to [instructor] students and adaptable.
        output: neutral
        Neutral example 2-
        input: The instructor should prepare materials and platform for student can student and do the lab more appropriate.
        output: neutral
        Now complete the following example-
        input: """
        
        self.atsc['bos_instruct2'] = """Definition: The output will be 'positive' if the sentence contains a positive sentiment. If the sentence in the input is negative the answer will be 'negative'.
        Otherwise, the output should be 'neutral'. For sentence which are classified as noaspectterm, the sentiment is neutral.
        Negative example 1-
        input: Please extend the period assignment deadline by a day.
        output: negative
        Negative example 2- 
        input: The number of assignments is quite too much.
        output: Negative
        Now complete the following example-
        input: """
        self.atsc['delim_instruct'] = ' The sentence is '
